var test = {
	...
	getScene: {
		...
		// 探测方式价值与意义
		detectionMethodsValueAndSignificance: "探测方式价值与意义",
		detectionPrincipleAndArchitecture: "探测原理及架构",
		detectingApplicationRange: "探测运用范围",
		detectionProcessAndRiskAnalysis: "探测流程及风险分析",
		endPreparationWork: "省端准备工作",
		alarmType: ["成功率", "交易量"],
		alarmPush: true,
		alarmPushMode: ["短信", "邮件"],
		required: ["渠道", "探测方式"],
